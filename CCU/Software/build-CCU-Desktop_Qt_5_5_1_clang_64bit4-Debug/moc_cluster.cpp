...
const QMetaObject Cluster::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Cluster.data,
      qt_meta_data_Cluster,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
