/****************************************************************************
** Meta object code from reading C++ file 'cameraCaptureBuffer.h'
**
...
#include "../CCU/cameraCaptureBuffer.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'cameraCaptureBuffer.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CaptureBuffer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CaptureBuffer_t qt_meta_stringdata_CaptureBuffer = {
    {
QT_MOC_LITERAL(0, 0, 13) // "CaptureBuffer"
...
const QMetaObject CaptureBuffer::staticMetaObject = {
    { &QAbstractVideoSurface::staticMetaObject, qt_meta_stringdata_CaptureBuffer.data,
      qt_meta_data_CaptureBuffer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CaptureBuffer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CaptureBuffer.stringdata0))
